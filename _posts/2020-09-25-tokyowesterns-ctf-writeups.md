...
![3]({{ '/assets/img/posts/tokyowesterns/tokyowesterns_3.png' | prepend: site.url }})
...
![1]({{ '/assets/img/posts/tokyowesterns/tokyowesterns_1.png' | prepend: site.url }})

### payload

![2]({{ '/assets/img/posts/tokyowesterns/tokyowesterns_2.png' | prepend: site.url }})
