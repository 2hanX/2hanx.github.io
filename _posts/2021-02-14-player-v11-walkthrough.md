...
![1]({{ '/assets/img/posts/player_v1.1/1.png' | prepend: site.url }})
...
![2]({{ '/assets/img/posts/player_v1.1/2.png' | prepend: site.url }})


### 访问 Web 并确定 Web 应用

![3]({{ '/assets/img/posts/player_v1.1/3.png' | prepend: site.url }})
...
![4]({{ '/assets/img/posts/player_v1.1/4.png' | prepend: site.url }})
...
![5]({{ '/assets/img/posts/player_v1.1/5.png' | prepend: site.url }})
...
![6]({{ '/assets/img/posts/player_v1.1/6.png' | prepend: site.url }})
